    ...
    <div class="row mt-4 mb-2">
        <div class="col">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('products') }}" class="text-dark">Daftar Jersey</a></li>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="card product">
                    <div class="card-body">
                        <img src="{{ url('assets/assets/jersey') }}/{{ $product->gambar }}" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-4">
                ...
                <h4>
                    ...
                    <span class="badge badge-success"><i class="fas fa-check"></i> Barang Tersedia</span>
                    @else
                    <span class="badge badge-danger"><i class="fas fa-times"></i> Barang Tidak Tersedia</span>
                    @endif
                </h4>
                    ...
                    <div class="col">
                        ...
                        <table class="table" style="border-top: hidden">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <img src="{{ url('assets/assets/liga') }}/{{ $product->liga->gambar }}" class="img-fluid" width="50">
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis</td>
