                                    ...
                                    @forelse ($pesanans as $pesanan)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ url('assets/assets/jersey') }}/{{ $pesanan_detail->product->gambar }}" class="img-fluid" width="50">
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    <div class="card-body">
                        <p>Untuk pembayaran, silakan transfer ke rekening yang tertera di bawah : </p>
                <div class="media">
